...
export default function PteListeningMultipleChoiceSingleAnswerPage() {
    const [currentTest] = useState(pteListeningMultipleChoiceSingleAnswerData[0]);
    ...
    return (
        <div className="w-full">
            <div className="mx-auto max-w-4xl space-y-4">
                ...
                <Card>
                    <CardHeader>
                        <CardTitle className="text-3xl font-headline">PTE Listening: Multiple-Choice, Single Answer</CardTitle>
                        <CardDescription>Listen to the recording and answer the multiple-choice question.</CardDescription>
                    </CardHeader>
                    <CardContent>
                        ...
                        <p className="font-semibold text-lg mb-4">{currentTest.question}</p>
