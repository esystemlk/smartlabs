          ...
          <div className="space-y-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              >
                ...
                <Card className="relative h-full flex flex-col glass-card border-none bg-white/5 backdrop-blur-xl shadow-2xl overflow-hidden hover:translate-y-[-10px] transition-all duration-500">
                  <div className="bg-[#1E40AF] p-6 text-white relative overflow-hidden">
                    ...
                    <p className="text-white/80 text-sm mt-2 font-medium italic">Essential for IELTS & PTE</p>
                  </div>
              ...
              <motion.div
                ...
                className="group relative"
              >
                <div className="absolute inset-0 bg-gradient-to-br from-accent-2/20 to-primary/20 blur-3xl opacity-0 group-hover:opacity-100 transition-opacity" />
                <Card className="relative h-full flex flex-col glass-card border-none bg-white/5 backdrop-blur-xl shadow-2xl overflow-hidden hover:translate-y-[-10px] transition-all duration-500">
                  <div className="bg-accent-2 p-6 text-white relative overflow-hidden">
                    <div className="absolute top-0 right-0 p-4 opacity-10">
                      <Sparkles className="h-20 w-20" />
                    </div>
                    <Badge className="bg-white/20 hover:bg-white/30 text-white border-none mb-4 uppercase font-black tracking-widest text-[10px]">Premium Mastery</Badge>
                    <CardTitle className="text-2xl font-black font-headline tracking-tight">IELTS Mastery (Online)</CardTitle>
                    <p className="text-white/80 text-sm mt-2 font-medium italic">Target Band 7+ Strategic Preparation</p>
                  </div>
                  <CardContent className="flex-grow p-8 space-y-6">
                    <div className="space-y-4">
                      <div className="flex flex-col gap-2 py-2 border-b border-white/10">
                        <div className="flex justify-between items-center text-xs font-black uppercase text-muted-foreground font-headline">
                          <span>Thu & Fri Online</span>
                          <span className="text-accent-2">8PM - 10PM</span>
                        </div>
                        <div className="flex justify-between items-center text-xs font-black uppercase text-muted-foreground font-headline">
                          <span>Mon & Fri Extra</span>
                          <span className="text-accent-2">8PM - 10PM (2w)</span>
                        </div>
                      </div>
                      <div className="flex items-center justify-between py-2 border-b border-white/10">
                        <span className="text-sm font-bold text-muted-foreground uppercase font-black text-accent-2">Bonus</span>
                        <span className="font-black text-xs">Grammar (Sat & Sun 4pm)</span>
                      </div>
                    </div>

                    <ul className="space-y-3">
                      {["Full class recordings", "AI practice platform access", "Strategies for all 4 modules", "Writing templates + samples", "Physical & Hybrid options available"].map((item, i) => (
                        <li key={i} className="flex items-start gap-3 text-sm font-medium">
                          <Check className="h-4 w-4 text-accent-2 mt-1 shrink-0" />
                          <span>{item}</span>
                        </li>
                      ))}
                    </ul>
                    ...
                    <div className="pt-6">
                      <div className="text-center space-y-1">
                        <p className="text-xs text-muted-foreground font-black uppercase tracking-widest">Mastery Fee</p>
                        <div className="text-4xl font-black text-foreground font-headline tracking-tighter">LKR 40,000</div>
                      </div>
                    </div>
                  </CardContent>
                  <CardFooter className="p-8 pt-0 gap-3">
                    <Button asChild variant="outline" className="flex-1 h-14 rounded-2xl border-accent-2/30 hover:bg-accent-2/5">
                      <Link href="/ielts">View All</Link>
                    </Button>
                    <Button asChild className="flex-[2] h-14 rounded-2xl bg-accent-2 hover:bg-accent-2/90 text-white font-black text-lg group shadow-xl shadow-accent-2/20">
                      <Link href={LMS_URL}>
                        Join Now
                        <ArrowRight className="ml-2 h-5 w-5 transition-transform group-hover:translate-x-1" />
                      </Link>
              ...
              >
                ...
                <Card className="relative h-full flex flex-col glass-card border-none bg-white/5 backdrop-blur-xl shadow-2xl overflow-hidden hover:translate-y-[-10px] transition-all duration-500">
                  <div className="bg-blue-600 p-6 text-white relative overflow-hidden">
                    ...
                    <CardTitle className="text-2xl font-black font-headline tracking-tight">IELTS Physical Only</CardTitle>
                    <p className="text-white/80 text-sm mt-2 font-medium italic">Face-to-face coaching - 12 Seats</p>
                  </div>
                  <CardContent className="flex-grow p-8 space-y-6">
                    <div className="space-y-4">
                      <div className="flex items-center justify-between py-2 border-b border-white/10">
                        <span className="text-sm font-bold text-muted-foreground uppercase">Schedule</span>
                        <span className="font-black">Sat & Sun (11.30AM)</span>
                      </div>
                      <div className="flex items-center justify-between py-2 border-b border-white/10">
                        <span className="text-sm font-bold text-blue-600 uppercase font-black text-xs">Grammar</span>
                        <span className="font-black text-xs">Included (4 PM)</span>
                      </div>
                    </div>

                    <ul className="space-y-3">
                      {["Small group coaching", "Free Campus WiFi", "Practice with laptops", "All notes provided", "Speaking & writing drills"].map((item, i) => (
                        <li key={i} className="flex items-start gap-3 text-sm font-medium">
                    ...
                    <div className="pt-6">
                      <div className="text-center space-y-1">
                        <p className="text-xs text-muted-foreground font-black uppercase tracking-widest">Physical Fee</p>
                        <div className="text-4xl font-black text-foreground font-headline tracking-tighter">LKR 40,000</div>
                      </div>
                    </div>
                  </CardContent>
                  <CardFooter className="p-8 pt-0">
                    <Button asChild className="w-full h-14 rounded-2xl bg-blue-600 hover:bg-blue-700 text-white font-black text-lg group">
                      <Link href={LMS_URL}>
                        Reserve Seat
                        <ArrowRight className="ml-2 h-5 w-5 transition-transform group-hover:translate-x-1" />
                      </Link>
              ...
              >
                ...
                <Card className="relative h-full flex flex-col glass-card border-none bg-white/5 backdrop-blur-xl shadow-2xl overflow-hidden hover:translate-y-[-10px] transition-all duration-500">
                  <div className="bg-orange-500 p-6 text-white relative overflow-hidden">
                    ...
                    <Badge className="bg-white/20 hover:bg-white/30 text-white border-none mb-4 uppercase font-black tracking-widest text-[10px]">Standard Hybrid</Badge>
                    <CardTitle className="text-2xl font-black font-headline tracking-tight">IELTS Online + Physical</CardTitle>
                    <p className="text-white/80 text-sm mt-2 font-medium italic">Flexible Learning Structure</p>
                  </div>
                  <CardContent className="flex-grow p-8 space-y-6">
                    <div className="space-y-4">
                      <div className="flex flex-col gap-2 py-2 border-b border-white/10">
                        <div className="flex justify-between items-center text-xs font-black uppercase text-muted-foreground">
                          ...
                          <span className="text-orange-500">8PM - 10PM</span>
                        </div>
                        <div className="flex justify-between items-center text-xs font-black uppercase text-muted-foreground">
                    ...
                    <ul className="space-y-3">
                      {["Online access included", "Small group physical class", "Campus WiFi access", "Practice with laptops", "Academic study materials"].map((item, i) => (
                        <li key={i} className="flex items-start gap-3 text-sm font-medium">
                    ...
                    <div className="pt-6">
                      <div className="text-center space-y-1">
                        <p className="text-xs text-muted-foreground font-black uppercase tracking-widest">Hybrid Fee</p>
                        <div className="text-4xl font-black text-foreground font-headline tracking-tighter">LKR 50,000</div>
                      </div>
                    </div>
                  </CardContent>
                  <CardFooter className="p-8 pt-0">
                    <Button asChild className="w-full h-14 rounded-2xl bg-orange-500 hover:bg-orange-600 text-white font-black text-lg group">
                      <Link href={LMS_URL}>
                        Enroll Hybrid
                        <ArrowRight className="ml-2 h-5 w-5 transition-transform group-hover:translate-x-1" />
                      </Link>
              ...
              >
                ...
                <Card className="relative h-full flex flex-col glass-card border-none bg-white/5 backdrop-blur-xl shadow-2xl overflow-hidden hover:translate-y-[-10px] transition-all duration-500">
                  <div className="bg-primary p-6 text-white relative overflow-hidden">
                    ...
                    <Badge className="bg-white/20 hover:bg-white/30 text-white border-none mb-4 uppercase font-black tracking-widest text-[10px]">Supreme Hybrid</Badge>
                    <CardTitle className="text-2xl font-black font-headline tracking-tight leading-tight">Physical + Mastery Online</CardTitle>
                    <p className="text-white/80 text-sm mt-2 font-medium italic">Highest Intensity Preparation</p>
                  </div>
                  <CardContent className="flex-grow p-8 space-y-6">
                    <div className="space-y-4">
                      <div className="flex flex-col gap-2 py-2 border-b border-white/10">
                        <div className="flex justify-between items-center text-xs font-black uppercase text-primary font-bold">
                          <span>Physical (Sat/Sun)</span>
                          <span>11.30AM - 1.30PM</span>
                        </div>
                        <div className="flex justify-between items-center text-xs font-black uppercase text-muted-foreground">
                          <span>Online Mastery (Thu/Fri)</span>
                          <span>8PM - 10PM</span>
                        </div>
                      </div>
                    </div>
                    ...
                    <ul className="space-y-3">
                      {["Full class recordings", "AI practice platform", "Strategies for all 4 modules", "Writing templates + samples", "One Month Grammar Clinic"].map((item, i) => (
                        <li key={i} className="flex items-start gap-3 text-sm font-medium">
                    ...
                    <div className="pt-6">
                      <div className="text-center space-y-1">
                        <p className="text-xs text-muted-foreground font-black uppercase tracking-widest">Supreme Fee</p>
                        <div className="text-4xl font-black text-foreground font-headline tracking-tighter">LKR 55,000</div>
                      </div>
                    </div>
                  </CardContent>
                  <CardFooter className="p-8 pt-0">
                    <Button asChild className="w-full h-14 rounded-2xl bg-primary hover:bg-primary/90 text-white font-black text-lg group shadow-xl shadow-primary/20">
                      <Link href={LMS_URL}>
                        Enroll Supreme
                        <ArrowRight className="ml-2 h-5 w-5 transition-transform group-hover:translate-x-1" />
                      </Link>
