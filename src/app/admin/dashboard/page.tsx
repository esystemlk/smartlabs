    ...
    const navSections: NavSection[] = [
        ...
        },
        {
            ...
            items: [
                ...
                { title: 'Recorded Packages', desc: 'Monthly recorded-session bundles from Bunny', icon: Video, href: '/admin/dashboard/recorded-packages', badge: 'New', badgeColor: 'bg-rose-500/20 text-rose-600', accent: 'bg-rose-500/10' },
