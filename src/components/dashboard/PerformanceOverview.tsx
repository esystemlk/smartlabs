...
const radarData = [
    { subject: 'Listening', A: 85, fullMark: 90 },
    { subject: 'Speaking', A: 70, fullMark: 90 },
    { subject: 'Reading', A: 75, fullMark: 90 },
    { subject: 'Writing', A: 80, fullMark: 90 },
    { subject: 'Grammar', A: 65, fullMark: 90 },
    { subject: 'Vocab', A: 82, fullMark: 90 },
];
