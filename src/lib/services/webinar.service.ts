...
export const DEFAULT_WEBINAR_SETTINGS: WebinarSettings = {
  title: 'Free IELTS & PTE Strategy Webinar',
  description: 'Join our free webinar and learn powerful strategies to improve your IELTS and PTE scores.',
  date: '2026-03-15',
  time: '9:00 AM',
  meetingLink: '',
  isActive: true,
...
export async function registerForWebinar(
  ...
  try {
    ...
    return { success: true, message: '🎉 You are successfully registered for the webinar. The joining link will be sent to your email.' };
  } catch (error) {
